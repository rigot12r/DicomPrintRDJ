...
namespace SimpleDICOMToolkit.Client
{
    ...
    {
        public string JobLabel { get; set; } = "RDJ Print Job";

        public string ImageDisplayFormat { get; set; } = "STANDARD\\3,3";

        public FilmOrientation Orientation { get; set; } = FilmOrientation.Portrait;

        public FilmSize FilmSize { get; set; } = FilmSize.E8_5InX11In;
        ...
        public EmptyImageDensity EmptyImageDensity { get; set; } = EmptyImageDensity.White;
        ...
        public PrintColorType ColorType { get; set; } = PrintColorType.Color;
